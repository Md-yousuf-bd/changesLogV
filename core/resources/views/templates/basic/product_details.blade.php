                            ...
                            <div class="products-description pt-0">
                                <ul class="nav nav-tabs" id="productTabs">
                                    ...
                                    @if (gs('product_review'))
                                        <li class="review-rating-tab"><a href="#reviews" data-bs-toggle="tab">@lang('Reviews')({{ __($product->reviews_count) }})</a></li>
                                    @endif
                                </ul>
...
@push('script')
    <script>
        ...
        $(document).on('click', '.replyBtn', function() {
            let thisContent = $(this).closest('.content');
            thisContent.find('.review-reply-items').toggleClass('d-none');
        });
